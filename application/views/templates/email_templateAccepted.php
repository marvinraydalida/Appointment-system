														...
														<tr>
															<td style="width:100%;text-align:center;">
																<h1
																	...
																	<strong>Your dental application has
																		been approved.</strong></h1>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="10" cellspacing="0"
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p
																			...
																			please take note of your ticket number
																			below:</p>
																	</div>
																</div>
															</td>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td style="width:100%;text-align:center;padding-top:20px;">
																<h1
																	style="border: 1px solid rgba(199, 196, 196, .81); margin-top: 25px; font-weight: bold; color: #555555; font-size: 50px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; direction: ltr; font-weight: normal; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">
																	<strong><?php echo $appointmentTicket?></strong><br /></h1>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0" class="text_block"
														...
														<tr>
															<td style="padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p
																		...
																		<table width="100%"
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td><?php echo date("m/d/Y", strtotime($date))?> at <?php echo date('h:i a', strtotime($time))?></td>
																				</tr>
																				<tr>
																		...
																		<p
																			style=" border: 1px solid rgba(199, 196, 196, .81);  font-size: 13px; margin-top: 10px; text-align:center;">
																			<strong>IMPORTANT REMINDER
																				: Please come one hour before
																				the scheduled time.</strong></p>
																		<p
